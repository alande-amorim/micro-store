/**
 * Generated from Shopify API webhook 'orders/created' payload example
 * generated using https://quicktype.io
 * @see https://shopify.dev/docs/api/admin-rest/2024-01/resources/webhook#event-topics
 */
export interface WebhookOrderCreatedDto {
  id: number;
